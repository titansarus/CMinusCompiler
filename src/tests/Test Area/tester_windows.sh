...
for dir in ../PA3-Resources/TestCases/*; do
    ...
    python3 ../../compiler.py
    ./tester_Windows.exe > result.txt
    printf "\n\n\n\n=====================================>>>>> Running Test ${dir}...\n" >> log.txt
    printf "\n\n=====================================>>>>> Running Test ${dir}...\n" >> brief_results.txt
    printf "\n\n              *** semantic_errors.txt diffrences ***\n" >> log.txt
    diff -y -B -W 250 -w  --suppress-common-lines ./semantic_errors.txt "${dir}/semantic_errors.txt" >> log.txt
    diff -y -B -W 250 -w -q ./semantic_errors.txt "${dir}/semantic_errors.txt" >> brief_results.txt
