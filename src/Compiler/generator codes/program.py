...
Fun_declaration_prime.add_rule(["(", "#declareFunction", "#openScope", "#setFunctionScopeFlag", Params, ")", Compound_stmt, ])
...
Iteration_stmt.add_rule(["repeat", "#label", Statement, "until", "(", Expression, ")", "#until", "#handleBreaks", ])
Return_stmt.add_rule(["return", Return_stmt_prime, ])
Return_stmt_prime.add_rule([";", ])
Return_stmt_prime.add_rule([Expression, "#pop", ";", ])
...
Var_call_prime.add_rule(["(", "#startArgumentList", Args, "#endArgumentList", ")", ])
Var_call_prime.add_rule([Var_prime, ])
Var_prime.add_rule(["[", Expression, "]", "#array", ])
Var_prime.has_epsilon = True
Factor_prime.add_rule(["(", "#startArgumentList", Args, "#endArgumentList", ")", ])
