...
Declaration_initial.add_rule([Type_specifier, "#setForceDeclarationFlag", "ID", "#startNoPush", "#pid", "#endNoPush", "#unsetForceDeclarationFlag", ])
...
Params.add_rule(["int", "#setForceDeclarationFlag", "ID", "#pid", "#unsetForceDeclarationFlag", Param_prime, "#popParam", Param_list, ])
...
Selection_stmt.add_rule(["if", "(", Expression, ")", "#save", Statement, Else_stmt, ])
Else_stmt.add_rule(["endif", "#jpfFromSaved", ])
Else_stmt.add_rule(["else", "#saveAndJpfFromLastSave", Statement, "endif", "#jpFromSaved", ])
Iteration_stmt.add_rule(["repeat", "#label", "#startBreakScope", Statement, "until", "(", Expression, ")", "#until", "#handleBreaks", ])
Return_stmt.add_rule(["return", Return_stmt_prime, "#jumpBack", ])
...
Expression.add_rule(["ID", "#checkDeclaration", "#pid", "#uncheckDeclaration", B, ])
B.add_rule(["=", Expression, "#assign", ])
B.add_rule(["[", Expression, "]", "#array", H, ])
B.add_rule([Simple_expression_prime, ])
H.add_rule(["=", Expression, "#assign", ])
H.add_rule([G, D, C, ])
